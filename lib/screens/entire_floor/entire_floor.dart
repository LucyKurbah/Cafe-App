...
class EntireFloor extends StatefulWidget {
  EntireFloor({super.key});

  @override
  State<EntireFloor> createState() => _EntireFloorState();
}

class _EntireFloorState extends State<EntireFloor> {
  ...
  void _updateSecondTimePicker(TimeOfDay newTime) {
    ...
    setState(() {
      ...
      checkDateTimeAvailability(_floorList[0].id, _selectedtimeFrom.text, formattedTime);
    });
  }
                                                         ...
                                                         style: ButtonStyle(                                                           
                                                          ...
                                                          onPressed:  (){
                                                            // Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (ctx) => CartScreen()));
                                                             addCart(_floorList.isNotEmpty?_floorList[0].id:0,noOfHours.text, t_date, _selectedtimeFrom.text.toString(), _selectedtimeTo.text.toString());
                                                            },
                                                          );
                                                }
                                              )
  ...
  void calculateHours(String timeString1, String timeString2) {
      ...
      var price =_floorList.isNotEmpty?_floorList[0].price:1;
